...
interface IMasterChef {
    ...
    function pendingBBSwap(uint256 _pid, address _user) external view returns (uint256);
...
// File: contracts/BBSwapVault.sol

pragma solidity 0.6.12;

contract BBSwapVault is Ownable, Pausable {
    ...
    function calculateHarvestCakeRewards() external view returns (uint256) {
        uint256 amount = IMasterChef(masterchef).pendingBBSwap(0, address(this));
