...
// File: contracts/DeflationarySmartChefInitializable.sol

pragma solidity 0.6.12;
contract DeflationarySmartChefInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint16 public constant MAX_TOKEN_TAX_RATE = 3000;
...
// File: contracts/DeflationarySmartChefFactory.sol

pragma solidity 0.6.12;

contract DeflationarySmartChefFactory is Ownable {
    event NewDeflationarySmartChefContract(address indexed smartChef);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(DeflationarySmartChefInitializable).creationCode;
        bytes32 salt =
            keccak256(
        ...
        DeflationarySmartChefInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewDeflationarySmartChefContract(smartChefAddress);
    }
}
